#ifndef COMPENDIACORE_H
#define COMPENDIACORE_H
 ...
 *
 * CompendiaCore manages the file list model, the tag library, and coordinates
 ...
 */
class CompendiaCore : public QObject
{
    Q_OBJECT
private:
...
public:
     ...
     */
    explicit CompendiaCore(QObject *parent = nullptr);
     ...
     *
     * Files inside any \c .compendia_cache sub-directory are excluded.
