...
# CPack configuration for Luminism.
...
# ── Common metadata ────────────────────────────────────────────────────────────
set(CPACK_PACKAGE_NAME                "Luminism")
...
set(CPACK_PACKAGE_INSTALL_DIRECTORY   "Luminism")
set(CPACK_PACKAGE_EXECUTABLES         "luminism;Luminism")
...
if(WIN32)
    ...
    set(CPACK_PACKAGE_FILE_NAME   "Luminism-${PROJECT_VERSION}-Windows-x64")

    # Future NSIS variables (uncomment when adding Phase 2):
    # set(CPACK_NSIS_DISPLAY_NAME          "Luminism ${PROJECT_VERSION}")
    # set(CPACK_NSIS_INSTALL_ROOT          "$PROGRAMFILES64")
    # set(CPACK_NSIS_MUI_ICON              "${CMAKE_CURRENT_SOURCE_DIR}/resources/luminism.ico")
    # set(CPACK_NSIS_MUI_UNIICON           "${CMAKE_CURRENT_SOURCE_DIR}/resources/luminism.ico")
    # set(CPACK_NSIS_ENABLE_UNINSTALL_BEFORE_INSTALL ON)
    # set(CPACK_NSIS_URL_INFO_ABOUT        "https://github.com/merrillaldrich/luminism")
endif()
...
if(UNIX AND NOT APPLE)
    ...
    set(CPACK_PACKAGE_FILE_NAME "Luminism-${PROJECT_VERSION}-Linux-x86_64")
...
if(APPLE)
    ...
    set(CPACK_PACKAGE_FILE_NAME "Luminism-${PROJECT_VERSION}-macOS")
endif()
