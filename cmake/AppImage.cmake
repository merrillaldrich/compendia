...
add_custom_target(appimage
    ...
    # Step 3: Copy license files into AppDir so they are included in the image.
    ...
    # Step 4: Run linuxdeploy with the Qt plugin to bundle the app and produce
    ...
    COMMAND ${CMAKE_COMMAND} -E env
        ...
        "${_linuxdeploy_bin}"
            ...
            --icon-file "${CMAKE_CURRENT_SOURCE_DIR}/resources/compendia_icon.svg"
            --plugin qt
            --output appimage
