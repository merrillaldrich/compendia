...
1. Click the **+** button next to the tag family you want to add a tag to.
2. Enter a name for the tag.
3. Click **OK**. The tag appears inside its family in the Tag Library.

You can add as many tags as you like to each family.
